...
from api.views import UserProfileListView, UserProfileDetailView, ProductListView,ProductDetailView, OrderListView, OrderDetailView, UserOrdersView, UserProductsView
